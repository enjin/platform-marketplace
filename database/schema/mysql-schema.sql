...
CREATE TABLE `marketplace_bids` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `marketplace_bids_marketplace_listing_id_index` (`marketplace_listing_id`),
  KEY `marketplace_bids_wallet_id_index` (`wallet_id`),
  CONSTRAINT `marketplace_bids_marketplace_listing_id_foreign` FOREIGN KEY (`marketplace_listing_id`) REFERENCES `marketplace_listings` (`id`),
  CONSTRAINT `marketplace_bids_wallet_id_foreign` FOREIGN KEY (`wallet_id`) REFERENCES `wallets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `marketplace_listings` (
  ...
  `take_collection_chain_id` varchar(255) DEFAULT NULL,
  `take_token_chain_id` varchar(255) DEFAULT NULL,
  `amount` varchar(255) DEFAULT NULL,
  `price` varchar(255) DEFAULT NULL,
  `min_take_value` varchar(255) DEFAULT NULL,
  `fee_side` varchar(255) DEFAULT NULL,
  `creation_block` int unsigned DEFAULT NULL,
  `deposit` varchar(255) DEFAULT NULL,
  `salt` varchar(255) DEFAULT NULL,
  `type` varchar(255) NOT NULL DEFAULT 'FIXED_PRICE',
  `start_block` int unsigned DEFAULT NULL,
  `end_block` int unsigned DEFAULT NULL,
  `amount_filled` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `marketplace_listings_take_collection_chain_id_index` (`take_collection_chain_id`),
  KEY `marketplace_listings_take_token_chain_id_index` (`take_token_chain_id`),
  CONSTRAINT `marketplace_listings_seller_wallet_id_foreign` FOREIGN KEY (`seller_wallet_id`) REFERENCES `wallets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `marketplace_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marketplace_states` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `marketplace_states_marketplace_listing_id_index` (`marketplace_listing_id`),
  CONSTRAINT `marketplace_states_marketplace_listing_id_foreign` FOREIGN KEY (`marketplace_listing_id`) REFERENCES `marketplace_listings` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
